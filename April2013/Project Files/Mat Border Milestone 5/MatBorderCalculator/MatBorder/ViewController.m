...
- (IBAction)savedButtonPressed:(id)sender {
    ...
    SavedListViewController *savedListController = [[SavedListViewController alloc] init];
    [self presentViewController:savedListController animated:YES completion:nil];
}
