...
- (id)initWithFrame:(CGRect)frame {
    ...
    if(self) {
        ...
        self.imageView.frame = self.matBorderView.frame; // CGRectMake(self.bounds.origin.x + inset,
...
//        [UIView animateWithDuration:.1 animations:^{
        ...
        NSLog(@"Mat: %@", NSStringFromCGRect(self.matBorderView.frame));
        NSLog(@"Image: %@", NSStringFromCGRect(self.imageView.frame));
        
        NSLog(@"Mat: %@", NSStringFromCGRect(self.matBorderView.bounds));
        NSLog(@"Image: %@", NSStringFromCGRect(self.imageView.bounds));
